...
export default class TodoItem extends Component {
  ...
  rendNorm() {
    return (
        <div className='box'>
          ...
          <button className="btn btn-light" onClick={this.edit}>Редактировать</button>
          <button className="btn red" onClick={this.remove}>удалить</button>
          <input type="checkbox" defaultChecked={this.state.check} onChange={this.handelChenge}/>
  ...
  rendEdit() {
    return (
        ...
        <div className='box'>
          <textarea className='text' defaultValue={this.state.children} ref='textarea'/>
